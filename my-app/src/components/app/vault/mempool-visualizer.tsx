    ...
    <div className={`w-full bg-gray-900/50 border border-gray-800 rounded-[4.5px] overflow-hidden backdrop-blur-sm ${className}`}>
      ...
      <div className="px-8 py-6 border-b border-gray-800/50 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="w-2 h-2 rounded-[4.5px] bg-green-500 animate-pulse shadow-[0_0_10px_rgba(34,197,94,0.5)]" />
        ...
        <div className="flex gap-6 text-xs font-medium text-gray-500 uppercase tracking-wider">
          ...
          <div className="flex items-center gap-2">
            <span className="w-1.5 h-1.5 rounded-[4.5px] bg-blue-500" />
            Verified Batch
          </div>
        </div>
      </div>
...
function GoldbackTicket({ serial }: { serial: GoldbackSerialRecord }) {
  return (
    <div className="group w-40 relative">
      <div className="absolute inset-0 bg-[#c9a84c]/20 blur-lg opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-[4.5px]" />
      <div className="relative bg-gray-900 border border-gray-800 hover:border-[#c9a84c]/50 p-3 transition-all duration-300 group-hover:-translate-y-1 rounded-[4.5px]">
        <div className="flex items-center justify-between mb-2">
          <div className="w-6 h-6 bg-[#c9a84c]/10 flex items-center justify-center text-[#c9a84c] text-[10px] font-bold rounded-[4.5px]">
            $1
          </div>
...
function BatchBlock({ batch }: { batch: BatchStats }) {
  return (
    <div className="group w-48 relative shrink-0">
      <div className="absolute inset-0 bg-blue-500/10 blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-[4.5px]" />
      <div className="relative bg-gray-900 border border-gray-800 hover:border-blue-500/50 p-4 transition-all duration-300 group-hover:-translate-y-1 rounded-[4.5px]">
        <div className="flex justify-between items-start mb-3">
          ...
          <div className="p-1.5 bg-gray-800 text-green-400 rounded-[4.5px]">
